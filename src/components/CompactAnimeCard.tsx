...
interface Props {
  anime: JikanAnime;
  /** Slide-up delay (seconds) for staggered grid entrance. */
  delay?: number;
}

/**
 * Hi-density poster card with [SUB]/[DUB] badges in the top right.
 * Smaller footprint than AnimeCard — used in the dense main-column grids.
 */
export function CompactAnimeCard({ anime, delay = 0 }: Props) {
